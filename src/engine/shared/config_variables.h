...
MACRO_CONFIG_INT(SndEnable, snd_enable, 0, 0, 0, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Sound enable")
MACRO_CONFIG_INT(SndMusic, snd_enable_music, 0, 0, 0, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Play background music")
